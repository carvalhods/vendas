...
module.exports = function(app){
    var Schema = mongoose.Schema({
        ...
        unidade: {
            type: String,
            required: [true, "É necessário preencher o campo 'Unidade'"],
            default: 'UN',
            enum: {
        ...
        qtde: {
            type: Number,
            required: [true, "É necessário preencher o campo 'Qtde.'"],
            min: [0, 'A qtde. do produto deve ser maior ou igual a zero'],
            max: [9999999, 'Qtde. máxima ultrapassada']
        },
        estoqueMin: {
            type: Number,
            required: [true, "É necessário preencher o campo 'Estoque Mínimo'"],
            min: [0, 'O estoque mínimo deve ser maior ou igual a zero']
        },
        valor: {
            type: Number,
            required: [true, "É necessário preencher o campo 'Valor Unitário'"],
